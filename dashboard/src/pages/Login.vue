...
<template>
  <div class="min-h-screen flex w-full">
    <!-- Left Side - Branding -->
    <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-primary to-primary-foreground relative overflow-hidden items-center justify-center p-12">
      ...
      <div class="relative z-10 text-white max-w-lg">
        <div class="mb-8 flex items-center gap-3">
          ...
          <h1 class="text-4xl font-black tracking-tight">AeroDB</h1>
        </div>
        <h2 class="text-3xl font-bold mb-4">Control your data with precision.</h2>
        <p class="text-lg text-white/80 leading-relaxed">
          Manage your databases, functions, and clusters from a single powerful dashboard.
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
      <div class="w-full max-w-md space-y-8">
        <div class="text-center lg:text-left">
          ...
          <p class="mt-2 text-muted-foreground">Sign in to your admin account</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div v-if="errorMessage" class="p-3 bg-destructive/10 text-destructive rounded-md text-sm font-medium flex items-center gap-2">
          ...
          <button
            ...
            class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full shadow-md"
          >

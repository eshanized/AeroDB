...
1. **Read the Vision**: Review [CORE_VISION.md](CORE_VISION.md)
...
- **Public APIs**: Update `CORE_API_SPEC.md`
- **User Behavior**: Update README.md
- **Architecture**: Update relevant `PHASE*` files
